...
from actor_critic import CnnPolicy, get_actor_critic
...
def train(policy, save_name, load_count = 0, summarize=True, load_path=None, log_path = './logs'):
    ...
    for update in tqdm(range(load_count + 1, TOTAL_TIMESTEPS + 1)):
        ...
        mb_obs = np.asarray(mb_obs, dtype=np.float32).reshape(batch_ob_shape) 
...
if __name__ == '__main__':
    train(CnnPolicy, "a2c", summarize=True, log_path='./a2c_logs')
